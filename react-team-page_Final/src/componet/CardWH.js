...
function WebHead (props){
    return (
        ...
        <img className="h-[7rem] rounded-full border-2 border-solid border-green-400" src={props.src} />
           </div>
        <section className=" text-white text-md flex justify-center flex-col gap-0.5">
            
        <span>{props.name}</span>
        <button className="p-1 bg-[#A3FD9B] text-black font-semibold ">{props.post}</button>
